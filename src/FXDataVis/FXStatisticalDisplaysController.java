...
public class FXStatisticalDisplaysController {
	...
	//Get resources. 
	ImageView left = new ImageView(new Image(getClass().getResourceAsStream("/FXDataVis/left.png")));
	ImageView right = new ImageView(new Image(getClass().getResourceAsStream("/FXDataVis/right.png")));
	/**
	...
	private void initializeButtons()
	{
		...
		barChart.getStylesheets().add(getClass().getResource("/FXDataVis/barChartCSS.css").toExternalForm());
		barChart.applyCss();
	...
	public void setTestValues5()
	{
	 ...
	 public void setRegionName(String regionName)
	 {
		 ...
		 anchorPane.setTopAnchor(regionNameLabel, 0.0);
